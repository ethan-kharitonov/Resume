...
\begin{document}
	...
	{\scriptsize \textit{ \footnotesize{\newline{}\textbf{Notable courses:} Fundementals of Computer Science I and II, Theory of Computation, Analysis I and II, Abstract Algebra I, Software Design, currently taking Analysis II and Statistics I}}}
	\resumeSubheading
	...
	{\\- Spent about 5 months developing this website by myself then an additional month working together with another intern\\- Used daily by the QA team\\- Wrote front-end in React and back-end using ASP.NET Core and Entity Framework\\ - Implemented real-time updates using SignalR\\- Deployed the site to IIS using Azure Pipelines}
